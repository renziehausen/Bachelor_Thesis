...
bitPhaseFlipList = [math.sqrt(0.7) * tensoredId(1), math.sqrt(1-0.7) * qt.sigmay()]
...
def randomNetwork(qnnArch, numTrainingPairs):
    ...
    networkTrainingData = TrainingData(bitPhaseFlipList, numTrainingPairs)
...
def testaverage(numberOfRunsToAverage,maxPairs,untrainedTestData):
    testStates = TrainingData(bitPhaseFlipList,untrainedTestData)#Liste mit nicht trainierten Datenpunkten
    outputList = [[],[],[]]
...
columns = "N,a,b,c"
np.savetxt("bitphaseflip 1-2-1 network lda05-1-2 eps01.csv",
...
columns = "N,a,b,c,d"
np.savetxt("bitphaseflipdifferentnetworks121o11o131o1221.csv",
...
np.savetxt("bitphaseflip 1-2-1 10training pairs 20avg 10trainingdata.csv",
