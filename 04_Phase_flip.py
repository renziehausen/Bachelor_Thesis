...
phaseFlipList = [math.sqrt(0.7) * tensoredId(1), math.sqrt(1-0.7) * qt.sigmaz()]
...
columns = "N,a,b,c"
np.savetxt("phaseflip 1-2-1 network lda05-1-2 eps01.csv",
...
columns = "N,a,b,c,d"
np.savetxt("phaselipdifferentnetworks121o11o131o1221.csv",
